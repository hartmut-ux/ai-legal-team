...
# Practice Operations — Claude Code wrapper

This is the **Claude Code wrapper** for `practice-operations`. The full skill definition lives in `shared/SKILL-CORE.md` in the same skill folder.
